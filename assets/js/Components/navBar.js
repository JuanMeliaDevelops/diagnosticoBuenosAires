    ...
    <div class="relative flex items-center justify-between w-full -mx-4">
                    ...
                    <ul class="block lg:flex 2xl:ml-20">
                        ...
                        <li class="submenu-item group relative">
                            <a href="javascript:void(0)"
                                class="relative mx-8 flex  justify-between py-2  font-medium text-dark group-hover:text-primary dark:text-white lg:ml-8 lg:mr-0 lg:inline-flex lg:py-6 lg:pl-0 lg:pr-4 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10">
                                Estudios

                                <svg id="dropdown" class="ml-2 fill-dropdown" width="16" height="20"
        ...
        <div class=" flex items-center justify-end pr-16 lg:pr-0">
            ...
            <div class="hidden sm:flex items-center">
              <a
                href="#"
                class="loginBtn px-[22px] py-2  font-medium text-white hover:opacity-70"
              >
                Turnos
              </a>
              <a
