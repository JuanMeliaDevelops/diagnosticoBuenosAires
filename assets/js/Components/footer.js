  ...
  <div class="-mx-4 flex flex-wrap">
    ...
    <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
      <div class="mb-10 w-full">
        ...
        <ul>
          <li>
            <a href="index.html" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Inicio
            </a>
          </li>
          <li>
            <a href="index.html#lab" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Laboratorio
            </a>
          </li>
          <li>
            <a href="index.html#kine" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Kinesiología
            </a>
          </li>
          <li>
            <a href="index.html#quirofano" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Quirófano
            </a>
          </li>
          <li>
            <a href="index.html#institucional" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Institucional
            </a>
          </li>
          <li>
            <a href="index.html#consultorio" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
    ...
    <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
      <div class="mb-10 w-full">
        <h4 class="mb-9 text-lg font-semibold text-white">Estudios</h4>
        <ul>
          <li>
            <a href="#nuclear" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Resonancia Nuclear Magnética de Alto campo
            </a>
          </li>
          <li>
            <a href="#tomografia" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Tomografía Multislice Helicoidal
            </a>
          </li>
          <li>
            <a href="#radio" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Radiología
            </a>
          </li>
          <li>
            <a href="#eco" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Ecografía
            </a>
          </li>
          <li>
            <a href="#mamo" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Mamografía
            </a>
          </li>
    ...
    <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
      <div class="mb-10 w-full">
        <h4 class="mb-9 text-lg font-semibold text-white"><br></h4>
        <ul>
          <li>
            <a href="#densi" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Densitometría
            </a>
          </li>
          <li>
            <a href="#ecoDop" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Ecodopleer
            </a>
          </li>
          <li>
            <a href="#madLab" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Departamento de Medicina Laboral
            </a>
          </li>
          <li>
            <a href="#medDol" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
              Departamento de medicina del dolor
            </a>
          </li>
          <li>
            <a href="#medTrans" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
